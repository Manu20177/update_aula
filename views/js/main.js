$(document).ready(function(){
    ...
    $('.ajaxDataForm').submit(function(e){
        ...
        }else if(formType==="AddCurso"){
            alertText="Quieres agregar un Curso al sistema";
        }else if(formType==="DellCurso"){
            alertText="Al eliminar el Curso del sistema ten en cuenta que también la Portada asociada al Curso se eliminara";
        }else if(formType==="UpdateCurso"){
            alertText="Los datos del Curso se actualizarán al realizar la operación  solicitada";
        }else{
     ...
     /*----------------------------------------------------
     * Formulario de Evaluación: .ajaxDataFormEvaluacion
