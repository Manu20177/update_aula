...
<div class="container-fluid">
	<div class="page-header">
	  <h1 class="text-titles"><i class="zmdi zmdi zmdi-assignment"></i> Encuestas <small>(Registro)</small></h1>
	</div>
	<p class="lead">
		Bienvenido a la sección de Encuestas, aquí cargar las encuestas para las clases.
	</p>
</div>
<div class="container-fluid">
...
<?php 
	...
	$query=$insVideo->execute_single_query("SELECT c.*,cu.Titulo as Curso FROM clase c LEFT JOIN encuesta_rapida er ON c.id = er.id_clase LEFT JOIN curso_clase cc on cc.id_clase=c.id LEFT JOIN curso cu on cu.id_curso=cc.id_curso WHERE er.id_clase IS NULL;
		...
		<div class="col-xs-12">
			<div class="panel panel-info">
				<div class="panel-heading">
				    <h3 class="panel-title"><i class="zmdi zmdi-plus"></i> Nueva Encuesta</h3>
				</div>
			  	<div class="panel-body">
				    <form action="<?php echo SERVERURL; ?>ajax/ajaxEncuestaadd.php" method="POST" enctype="multipart/form-data" autocomplete="off" data-form="AddCurso" class="ajaxDataForm">
				    		...
				    		<div class="container-fluid">
				    			<div class="row">
									...
									<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
										  	<span class="control-label">Encuesta *</span>
										...
										<a href="../archivos/encuesta/plantilla_encuesta.xlsm">Descargar Plantilla</a>
