<?php 
	...
	if ($query->rowCount()>0) {
		...
		# code...
		$cursop.="<p style='margin-left:25%'>".$key['tcurso']."</p>";
		}
	}else{
		$cursop.="LA CLASE NO ESTA INSTRUIDA EN NINGUN CURSO";
...
<div class="container-fluid">
	<div class="row">
		<div class="col-xs-12">
			...
			<p class="text-mutted"><i class="zmdi zmdi-hourglass-alt"></i> HORAS DE CLASE: <strong><?php echo $rows['horas']." Horas"; ?></strong></p>
			...
			<p class="text-mutted"><i class="zmdi zmdi-format-list-bulleted"></i> PERTENECIENTE AL CURSO: <strong><?php echo $cursop; ?></strong></p>
