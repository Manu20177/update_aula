<?php 
	...
	?>
	<script>
	window.idJuegoActual = "<?php echo $juego; ?>";
...
// Verificar si el usuario ya respondi¨® la evaluaci¨®n
	$yaRespondio = $insJuego->check_juego_respondido_controller($_SESSION['userKey'], $juego);
...
<?php if ($yaRespondio): ?>
                    ...
                    <div class="alert alert-success text-center" style="margin-top: 25%;" role="alert">
                        Ya has completado este Desafio. Gracias
                    </div>
                <?php else: ?>
...
<p class="lead text-center">Lo sentimos ocurri¨® un error inesperado</p>
<?php endif; ?>